...
#if defined(__MINGW32__)
//https://github.com/dAck2cC2/m3e/blob/307de5a246fa50719b6b10fff8934a89edb819fd/src/external/msvc/src/ffs.c
...
#else
            trace = malloc(depth * 2 * sizeof(void*));
#endif
...
#else
	threads = malloc(count * sizeof(Object*));
#endif
